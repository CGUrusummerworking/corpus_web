...
class CalculatorTest(unittest.TestCase):
    ...
    def getfilecontent(self, file):
        ...
        f = open(join(dirname(__file__), file), 'r', encoding='UTF-8')
        while True:
            content = (f.readline())
            if not content:
                break
...
# input
    ...
    def test_starttime(self):
        ...
        self.assertEqual(self.getfiletime(inputF), self.starttime)
    ...
    def test_content(self):  # content 有字的翻譯
        ...
        self.assertEqual(self.getfilecontent(inputF), self.talkcontent)
    ...
    def test_spk1(self):
        ...
        self.assertEqual(self.getfilespk(input1), self.speaker1)
    ...
    def test_starttime1(self):
        ...
        self.assertEqual(self.getfiletime(input1), self.starttime1)
    ...
    def test_spk2(self):
        ...
        self.assertEqual(self.getfilespk(input2), self.speaker2)
    ...
    def test_starttime2(self):
        ...
        self.assertEqual(self.getfiletime(input2), self.starttime2)
